...
using ooohCar.Application.Interfaces.Services.Account;
using ooohCar.Application.Interfaces.Services.Identity;
using ooohCar.Application.Models.Identity;
using ooohCar.Infrastructure;
using ooohCar.Infrastructure.Contexts;
using ooohCar.Infrastructure.Repositories;
using ooohCar.Infrastructure.Services;
using ooohCar.Infrastructure.Services.Identity;
using ooohCar.Infrastructure.Shared.Services;
using ooohCar.Server.Permission;
using ooohCar.Server.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ooohCar.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
        ...
        public static IServiceCollection AddDatabase(
            ...
            IConfiguration configuration)
            => services
                .AddDbContext<CarsContext>(options => options
        ...
        public static IServiceCollection AddIdentity(this IServiceCollection services)
        {
            services
                ...
                .AddIdentity<CarUser, IdentityRole>(options =>
                {
